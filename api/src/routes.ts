...
import * as PortalCustomEventController from "@/src/controllers/portal/custom-events"
...
router.all('/portal/custom-event/count', PortalCustomEventController.customEventCount);
